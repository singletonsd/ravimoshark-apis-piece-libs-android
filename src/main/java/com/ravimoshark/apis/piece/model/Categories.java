 ...
 */
@JsonAdapter(Categories.Adapter.class)
public enum Categories {
  ALL("ALL"),
  DETERGENTS("DETERGENTS"),
  DISHWASHER("DISHWASHER"),
  MACHINES("MACHINES"),
  REPAIRED_PIECES("REPAIRED_PIECES"),
  ...
  public static class Adapter extends TypeAdapter<Categories> {
    @Override
    public void write(final JsonWriter jsonWriter, final Categories enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public Categories read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return Categories.fromValue(String.valueOf(value));
    }
  }
}
