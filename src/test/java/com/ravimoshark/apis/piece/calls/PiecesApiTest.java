...
public class PiecesApiTest {
     ...
     */
    @Test
    public void getPieceByIdTest() throws ApiException {
        String refArticle = null;
        Deleted deleted = null;
        Pieces response = api.getPieceById(refArticle, deleted);
    ...
    public void getPiecesTest() throws ApiException {
        ...
        InlineResponse2001 response = api.getPieces(skip, limit, orderBy, filterBy, deleted, metadata, category);
